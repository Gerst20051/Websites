...
else alert("We Are Sorry! CoD Requires A Browser That Supports jQuery.");
...
if ($) {
	$("div.noscript").remove();
	$("body").html('<h1 class="header">This is $(\'*\').addclass | Would you like to join an undefeatable clan. $(\'*\').name !</h1><h2 class="header">We don\'t recruit on server. We play on ThC\'s Broadcast SnD Server (IP 8.6.75.44)</h2><h2 class="header">Current Members Of $(\'*\').clan</h2>');

	var content = [
	'<div class="content">',
	'<div id="members">',
	'<div class="member">',
	'<div class="name">$(\'*\').addclass - Andrew Gerst - $(\'*\').addclass</div>',
	'<a href="http://profile.xfire.com/dotaddclass" target="_blank" class="profile"><img src="http://miniprofile.xfire.com/bg/sh/type/0/dotaddclass.png" width="440" height="111" /></a>',
	'</div><div class="member">',
	'<div class="name">$(\'*\').thesun - Kyle Durst - the sunilious</div>',
	'<a href="http://profile.xfire.com/sunilious" target="_blank" class="profile"><img src="http://miniprofile.xfire.com/bg/bg/type/0/sunilious.png" width="440" height="111" /></a>',
	'</div><div class="member">',
	'<div class="name">$(\'*\').I\'m Gone - When I\'m Gone</div>',
	'<a href="http://profile.xfire.com/dotaddclass" target="_blank" class="profile"><img src="http://miniprofile.xfire.com/bg/os/type/0/dotaddclass.png" width="440" height="111" /></a>',
	'</div><div class="member">',
	'<div class="name">$(\'*\').name - covert_bunny</div>',
	'<a href="http://profile.xfire.com/demitrea" target="_blank" class="profile"><img src="http://miniprofile.xfire.com/bg/co/type/0/demitrea.png" width="440" height="111" /></a>',
	'</div>',
	'</div>',
	'<div class="clearfix"></div>',
	'<div id="links">',
	'<div class="player"><a href="http://www.gametracker.com/server_info/8.6.75.44:28960/" target="_blank" class="player">ThC Server GT</a></div>',
	'<div class="player"><a href="http://www.gametracker.com/search/?search_by=online_player&query=$(\'*\')" target="_blank" class="player">Online Players GT</a></div>',
	'<div class="player"><a href="http://www.gametracker.com/search/?search_by=online_offline_player&query=$(\'*\')" target="_blank" class="player">Online / Offline Players GT</a></div>',
	'<div class="player"><a href="http://www.gametracker.com/search/?search_by=online_player&query=$(\'*\')" target="_blank" class="player">Online Players GT</a></div>',
	'<div class="player"><a href="/p/cod/server/mods/pezbot.zip" target="_blank" class="player">PeZBOT MOD</a></div>',
	'<div class="player"><a href="/p/cod/serverinfo.php?ip=" target="_blank" class="player">Server Info w/ IP</a></div>',
	'</div>',
	'<div class="clearfix"></div>',
	'<div id="banners">',
	'<div class="banner"><iframe src="http://cache.www.gametracker.com/components/html0/?host=8.6.75.44:28960&bgColor=1F2642&fontColor=8790AE&titleBgColor=11172D&titleColor=FFFFFF&borderColor=333333&linkColor=FF9900&borderLinkColor=999999&showMap=1&currentPlayersHeight=100&showCurrPlayers=1&topPlayersHeight=100&showTopPlayers=1&showBlogs=0&width=240" frameborder="0" scrolling="no" width="240" height="536"></iframe></div>',
	'<div class="banner"><iframe src="http://cache.www.gametracker.com/components/html0/?host=68.232.171.17:28960&bgColor=333333&fontColor=CCCCCC&titleBgColor=222222&titleColor=FF9900&borderColor=555555&linkColor=FFCC00&borderLinkColor=222222&showMap=1&currentPlayersHeight=100&showCurrPlayers=1&topPlayersHeight=100&showTopPlayers=1&showBlogs=0&width=240" frameborder="0" scrolling="no" width="240" height="536"></iframe></div>',
	'<div class="banner"><iframe src="http://cache.www.gametracker.com/components/html0/?host=173.199.66.86:28960&bgColor=333333&fontColor=CCCCCC&titleBgColor=222222&titleColor=FF9900&borderColor=555555&linkColor=FFCC00&borderLinkColor=222222&showMap=1&currentPlayersHeight=100&showCurrPlayers=1&topPlayersHeight=100&showTopPlayers=1&showBlogs=0&width=240" frameborder="0" scrolling="no" width="240" height="536"></iframe></div>',
	'<div class="banner"><iframe src="http://cache.www.gametracker.com/components/html0/?host=68.232.177.92:28960&bgColor=373E28&fontColor=D2E1B5&titleBgColor=2E3225&titleColor=FFFFFF&borderColor=3E4433&linkColor=889C63&borderLinkColor=828E6B&showMap=1&currentPlayersHeight=100&showCurrPlayers=1&topPlayersHeight=100&showTopPlayers=1&showBlogs=0&width=240" frameborder="0" scrolling="no" width="240" height="536"></iframe></div>',
	'<div class="banner"><iframe src="http://cache.www.gametracker.com/components/html0/?host=68.232.168.128:28960&bgColor=1F2642&fontColor=8790AE&titleBgColor=11172D&titleColor=FFFFFF&borderColor=333333&linkColor=FF9900&borderLinkColor=999999&showMap=1&currentPlayersHeight=100&showCurrPlayers=1&topPlayersHeight=100&showTopPlayers=1&showBlogs=0&width=240" frameborder="0" scrolling="no" width="240" height="536"></iframe></div>',
	'<div class="banner"><iframe src="http://cache.www.gametracker.com/components/html0/?host=68.232.173.8:28960&bgColor=333333&fontColor=CCCCCC&titleBgColor=222222&titleColor=FF9900&borderColor=555555&linkColor=FFCC00&borderLinkColor=222222&showMap=1&currentPlayersHeight=100&showCurrPlayers=1&topPlayersHeight=100&showTopPlayers=1&showBlogs=0&width=240" frameborder="0" scrolling="no" width="240" height="536"></iframe></div>',
	'<div class="banner"><iframe src="http://cache.www.gametracker.com/components/html0/?host=68.232.177.14:28960&bgColor=333333&fontColor=CCCCCC&titleBgColor=222222&titleColor=FF9900&borderColor=555555&linkColor=FFCC00&borderLinkColor=222222&showMap=1&currentPlayersHeight=100&showCurrPlayers=1&topPlayersHeight=100&showTopPlayers=1&showBlogs=0&width=240" frameborder="0" scrolling="no" width="240" height="536"></iframe></div>',
	...
	Skins:
	------------------------------------------------------------------
	Shadow: http://miniprofile.xfire.com/bg/sh/type/0/user.png
	Combat: http://miniprofile.xfire.com/bg/co/type/0/user.png
	Sci-Fi: http://miniprofile.xfire.com/bg/sf/type/0/user.png
	Fantasy: http://miniprofile.xfire.com/bg/os/type/0/user.png
	World of Warcraft: http://miniprofile.xfire.com/bg/wow/type/0/user.png
	XFire Default: http://miniprofile.xfire.com/bg/bg/type/0/user.png

	Size:
	------------------------------------------------------------------
	Classic: <img src="http://miniprofile.xfire.com/bg/sh/type/0/user.png" width="440" height="111" />
	Compact: <img src="http://miniprofile.xfire.com/bg/sh/type/1/user.png" width="277" height="63" />
	Short and White: <img src="http://miniprofile.xfire.com/bg/sh/type/2/user.png" width="450" height="34" />
	Tiny: <img src="http://miniprofile.xfire.com/bg/sh/type/3/user.png" width="149" height="29" />
	Micro: <img src="http://miniprofile.xfire.com/bg/sh/type/4/user.gif" width="16" height="16" />
	*/ ?>
}
